...
const FeaturedEvents = () => {
    ...
    if (loading) {
        return (
            <section id="events" style={{ backgroundColor: '#000000', padding: '4rem 0', minHeight: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <div style={{ color: '#d32f2f', fontSize: '1.2rem', fontWeight: 'bold' }}>Loading events...</div>
            </section>
        );
    }
    ...
    return (
        <section id="events" style={{ backgroundColor: '#000000' }}>
            <div className="container">
                ...
                {events.length === 0 ? (
                    <div style={{ color: '#666', textAlign: 'center', padding: '2rem' }}>No events currently available.</div>
                ) : (
                    <div style={{
                        display: 'grid',
